<aside
    ...
    <!-- Sidebar Header -->
    <!-- <div class="flex items-center justify-between gap-2 px-6 py-5 xl:py-6"
         :class="{ 'xl:justify-center xl:px-4': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
        <a href="/" class="flex items-center gap-3">
            <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500 text-white shadow-brand-500/20 shadow-lg">
            ...
            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" 
                  ...
                  class="text-xl font-bold tracking-tight text-gray-900">Orbit<span class="text-brand-500">Erp</span></span>
        </a>

        
        <button @click="$store.sidebar.setMobileOpen(false)" class="xl:hidden text-gray-500 hover:text-gray-700">
            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ isset($company) ? (is_object($company) ? route('companies.show', $company->slug) : route('companies.show', $company)) : route('companies.index') }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Dashboard</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('clients.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Clients</span>
                     </a>
                </li>
                <li>
                    <a href="{{ route('invoices.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Invoices</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('orders.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Orders</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('payments.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Payments</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('products.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Products</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('categories.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Categories</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('suppliers.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Suppliers</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('tasks.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Tasks</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('calender-events.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Calendar</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('conversations.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Messages</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('memberships.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Members</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('roles.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Roles</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('permissions.index', $company->slug) }}" 
                       class="menu-item {{ Request::routeIs('permissions.*') ? 'menu-item-active' : 'menu-item-inactive' }}"
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                        </svg>
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Permissions</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('trash.index', $company->slug) }}" 
                       ...
                       :class="{ 'xl:justify-center xl:px-2': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">
                        ...
                        <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered" class="truncate">Trash</span>
                    </a>
                </li>
                @endif
